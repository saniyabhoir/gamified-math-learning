...
const QuizCard = ({ screenData, onComplete, onAnswerLogged }) => {
  ...
  const handleSelect = useCallback((option) => {
    ...
    onAnswerLogged?.({
      ...
      // FIX: ModulePage.jsx builds weakTopics off a top-level `topic` field,
      // but the module JSON only ever nests the concept under
      // mistake_tracking.concept_tag. Without this, every wrong answer was
      // silently dropped from weak-topic detection — weakTopics came back
      // empty even for students who made plenty of mistakes.
